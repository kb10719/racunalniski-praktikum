...
imamo izbrane uteži za posamezne omejitve. Manjka le še glavni del recepta, ki 
...
\documentclass{article}
\usepackage[utf8]{inputenc}      % kodiranje znakov
\usepackage[T1]{fontenc}         % pravilno prikazovanje č, š, ž
\usepackage[slovene]{babel}      % deljenje besed in prevodi v slovenščino
